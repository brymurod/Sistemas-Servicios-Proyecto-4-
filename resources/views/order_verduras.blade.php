	...
	<div class="row" >
		<center>
			<div id="Categories" class="list-group pull-left">			
				<a id="Frutas_Categoria" class="list-group-item" style="width:150px;" href="{!!URL::to('/order/frutas')!!}">FRUTAS</a>
				<a id="Verduras_Categoria" class="list-group-item" style="background-color:#f3d0aa;color:white;width:150px" href="{!!URL::to('/order/verduras')!!}">VERDURAS</a>
			</div>
			<div id="Categories" class="list-group pull-right" style="margin-right:35px">	
				...
				{!! Form::open(['url' => 'order/search_Verduras', 'method' => 'GET', 'class' => 'navbar-form navbar-left pull right', 'role' => 'search'])!!}
